...
// Dữ liệu giao dịch mới nhất trong file nguồn dừng ở 13/09/2026, nên tuần cuối (W24, 07/09–13/09)
// đã trọn 7 ngày; tuần kế tiếp (14/09 trở đi) chưa có dữ liệu nên chưa được thêm vào.
...
export const WEEKS: { key: WeekKey; start: string; end: string; label: string; isPartial: boolean }[] = [
  ...
  { key: "W23", start: "2026-08-31", end: "2026-09-06", label: "31/08–06/09", isPartial: false },
  { key: "W24", start: "2026-09-07", end: "2026-09-13", label: "07/09–13/09", isPartial: false },
];

/** Tuần gần nhất đã trọn 7 ngày. */
export const DEFAULT_WEEK: WeekKey = "W24";
...
export const weeklyChannelData: Partial<Record<WeekKey, Record<string, WeeklyChannelMetrics>>> = {
  W1: {
    ...
    "Shopee-MCC": { gmv: 77329263, payout: 2846231, orders: 144, avgCommissionPct: 3.68, roas: 27.17, completionRatePct: 100, refundRatePct: 5.7 },
  ...
  W2: {
    ...
    "Shopee-MCC": { gmv: 24878412, payout: 979477, orders: 100, avgCommissionPct: 3.94, roas: 25.4, completionRatePct: 100, refundRatePct: 43.13 },
  ...
  W3: {
    ...
    "Shopee-MCC": { gmv: 33466280, payout: 1752631, orders: 99, avgCommissionPct: 5.24, roas: 19.09, completionRatePct: 100, refundRatePct: 6.16 },
  ...
  W4: {
    ...
    "Shopee-MCC": { gmv: 28966178, payout: 1741999, orders: 78, avgCommissionPct: 6.01, roas: 16.63, completionRatePct: 99.23, refundRatePct: 27.88 },
  ...
  W6: {
    ...
    "Shopee-MCC": { gmv: 77021277, payout: 3676266, orders: 85, avgCommissionPct: 4.77, roas: 20.95, completionRatePct: 100, refundRatePct: 14.8 },
    "Shopee-PC": { gmv: 31386389, payout: 2637361, orders: 38, avgCommissionPct: 8.4, roas: 11.9, completionRatePct: 100, refundRatePct: 3.12 },
  ...
  W7: {
    ...
    "Shopee-MCC": { gmv: 34869322, payout: 1857137, orders: 46, avgCommissionPct: 5.33, roas: 18.78, completionRatePct: 100, refundRatePct: 12.11 },
    "Shopee-PC": { gmv: 32037231, payout: 2279997, orders: 38, avgCommissionPct: 7.12, roas: 14.05, completionRatePct: 100, refundRatePct: 1.76 },
  ...
  W8: {
    ...
    "Shopee-MCC": { gmv: 41246250, payout: 2253035, orders: 82, avgCommissionPct: 5.46, roas: 18.31, completionRatePct: 100, refundRatePct: 16.39 },
    "Shopee-PC": { gmv: 34902959, payout: 2241487, orders: 50, avgCommissionPct: 6.42, roas: 15.57, completionRatePct: 100, refundRatePct: 4.48 },
  ...
  W9: {
    ...
    "Shopee-MCC": { gmv: 43186424, payout: 2120527, orders: 65, avgCommissionPct: 4.91, roas: 20.37, completionRatePct: 100, refundRatePct: 25.29 },
    "Shopee-PC": { gmv: 42150146, payout: 3312958, orders: 52, avgCommissionPct: 7.86, roas: 12.72, completionRatePct: 100, refundRatePct: 22.02 },
  ...
  W10: {
    ...
    "Shopee-MCC": { gmv: 105015146, payout: 5954557, orders: 91, avgCommissionPct: 5.67, roas: 17.64, completionRatePct: 100, refundRatePct: 16.3 },
    "Shopee-PC": { gmv: 80484657, payout: 6527664, orders: 92, avgCommissionPct: 8.11, roas: 12.33, completionRatePct: 100, refundRatePct: 9.54 },
  ...
  W11: {
    ...
    "Shopee-MCC": { gmv: 49303075, payout: 2470921, orders: 59, avgCommissionPct: 5.01, roas: 19.95, completionRatePct: 100, refundRatePct: 20.92 },
    "Shopee-PC": { gmv: 74124405, payout: 5460804, orders: 77, avgCommissionPct: 7.37, roas: 13.57, completionRatePct: 100, refundRatePct: 4.75 },
  ...
  W12: {
    ...
    "Shopee-MCC": { gmv: 78490730, payout: 5529486, orders: 86, avgCommissionPct: 7.04, roas: 14.19, completionRatePct: 100, refundRatePct: 21.49 },
    "Shopee-PC": { gmv: 97867334, payout: 5648178, orders: 120, avgCommissionPct: 5.77, roas: 17.33, completionRatePct: 100, refundRatePct: 5.53 },
  ...
  W13: {
    ...
    "Shopee-MCC": { gmv: 60583610, payout: 3046055, orders: 66, avgCommissionPct: 5.03, roas: 19.89, completionRatePct: 100, refundRatePct: 22.62 },
    "Shopee-PC": { gmv: 159536339, payout: 8829142, orders: 157, avgCommissionPct: 5.53, roas: 18.07, completionRatePct: 100, refundRatePct: 5.9 },
  ...
  W14: {
    ...
    "Shopee-MCC": { gmv: 37745727, payout: 1924179, orders: 46, avgCommissionPct: 5.1, roas: 19.62, completionRatePct: 100, refundRatePct: 7.93 },
    "Shopee-PC": { gmv: 119086338, payout: 6821855, orders: 151, avgCommissionPct: 5.73, roas: 17.46, completionRatePct: 100, refundRatePct: 9.15 },
  ...
  W15: {
    ...
    "Shopee-MCC": { gmv: 108721766, payout: 7101306, orders: 178, avgCommissionPct: 6.53, roas: 15.31, completionRatePct: 100, refundRatePct: 25.45 },
    "Shopee-PC": { gmv: 336990392, payout: 18979833, orders: 428, avgCommissionPct: 5.63, roas: 17.76, completionRatePct: 100, refundRatePct: 11.62 },
  ...
  W16: {
    ...
    "Shopee-MCC": { gmv: 65979911, payout: 4160887, orders: 101, avgCommissionPct: 6.31, roas: 15.86, completionRatePct: 100, refundRatePct: 41.35 },
    "Shopee-PC": { gmv: 301414757, payout: 18212666, orders: 376, avgCommissionPct: 6.04, roas: 16.55, completionRatePct: 100, refundRatePct: 11.81 },
  ...
  W17: {
    "Lazada-MCC": { gmv: 292500, payout: 22500, orders: 1, avgCommissionPct: 7.69, roas: 13, completionRatePct: null, refundRatePct: null },
    "Shopee-MCC": { gmv: 68703312, payout: 4701418, orders: 84, avgCommissionPct: 6.84, roas: 14.61, completionRatePct: 100, refundRatePct: 22.61 },
    "Shopee-PC": { gmv: 302706265, payout: 17733230, orders: 336, avgCommissionPct: 5.86, roas: 17.07, completionRatePct: 99.75, refundRatePct: 6.7 },
  ...
  W18: {
    ...
    "Shopee-MCC": { gmv: 47257709, payout: 3473138, orders: 66, avgCommissionPct: 7.35, roas: 13.61, completionRatePct: 81.28, refundRatePct: 12.47 },
    "Shopee-PC": { gmv: 271335117, payout: 16398363, orders: 297, avgCommissionPct: 6.04, roas: 16.55, completionRatePct: 80.69, refundRatePct: 11.36 },
    "TikTok Shop-MCC": { gmv: 73695530, payout: 3076697, orders: 233, avgCommissionPct: 4.17, roas: 23.95, completionRatePct: 53.49, refundRatePct: 0.59 },
    "TikTok Shop-PC": { gmv: 161778521, payout: 367049, orders: 75, avgCommissionPct: 0.23, roas: 440.75, completionRatePct: 4.67, refundRatePct: 0 },
  },
  W19: {
    "Lazada-MCC": { gmv: 268000, payout: 22500, orders: 1, avgCommissionPct: 8.4, roas: 11.91, completionRatePct: null, refundRatePct: null },
    "Shopee-MCC": { gmv: 128723372, payout: 8211307, orders: 125, avgCommissionPct: 6.38, roas: 15.68, completionRatePct: 100, refundRatePct: 14.61 },
    "Shopee-PC": { gmv: 465187891, payout: 27295013, orders: 523, avgCommissionPct: 5.87, roas: 17.04, completionRatePct: 99.72, refundRatePct: 12.72 },
    "TikTok Shop-MCC": { gmv: 139437102, payout: 6351199, orders: 357, avgCommissionPct: 4.55, roas: 21.95, completionRatePct: 57.51, refundRatePct: 3.55 },
    "TikTok Shop-PC": { gmv: 228119656, payout: 2909911, orders: 256, avgCommissionPct: 1.28, roas: 78.39, completionRatePct: 19.3, refundRatePct: 0.26 },
  },
  W20: {
  ...
  W23: {
    "Shopee-PC": { gmv: 291067756, payout: 15206809, orders: 325, avgCommissionPct: 5.22, roas: 19.14, completionRatePct: 84.56, refundRatePct: 8.49 },
    "Shopee-MCC": { gmv: 71590246, payout: 3582617, orders: 96, avgCommissionPct: 5.0, roas: 19.98, completionRatePct: 70.45, refundRatePct: 29.24 },
    "Lazada-MCC": { gmv: 302700, payout: 24300, orders: 1, avgCommissionPct: 8.03, roas: 12.46, completionRatePct: null, refundRatePct: null },
    "TikTok Shop-PC": { gmv: 110462871, payout: 2628302, orders: 127, avgCommissionPct: 2.38, roas: 42.03, completionRatePct: 33.35, refundRatePct: 0.0 },
    "TikTok Shop-MCC": { gmv: 152573632, payout: 5955640, orders: 358, avgCommissionPct: 3.9, roas: 25.62, completionRatePct: 48.06, refundRatePct: 0.55 },
  },
  W24: {
    "Shopee-PC": { gmv: 534096017, payout: 33279894, orders: 664, avgCommissionPct: 6.23, roas: 16.05, completionRatePct: 44.15, refundRatePct: 12.3 },
    "Shopee-MCC": { gmv: 117103780, payout: 8731002, orders: 147, avgCommissionPct: 7.46, roas: 13.41, completionRatePct: 51.28, refundRatePct: 6.58 },
    "Lazada-MCC": { gmv: 629200, payout: 52400, orders: 2, avgCommissionPct: 8.33, roas: 12.01, completionRatePct: null, refundRatePct: null },
    "TikTok Shop-PC": { gmv: 217657558, payout: 2096176, orders: 216, avgCommissionPct: 0.96, roas: 103.84, completionRatePct: 11.67, refundRatePct: 0.0 },
    "TikTok Shop-MCC": { gmv: 176913356, payout: 3926801, orders: 505, avgCommissionPct: 2.22, roas: 45.05, completionRatePct: 24.57, refundRatePct: 0.0 },
  },
};
