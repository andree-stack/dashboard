...
export function BuGroupedBar({ data, height }: { data: BuGroupedBarRow[]; height?: number }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={h}>
      <BarChart data={data} layout="vertical" margin={{ top: 4, right: 48, left: 4, bottom: 4 }} barGap={4}>
        ...
        <XAxis type="number" tickFormatter={(v) => formatVnd(v)} tickLine={false} axisLine={false} tick={{ fontSize: 11 }} />
